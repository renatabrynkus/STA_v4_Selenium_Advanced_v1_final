...
public class FilterPage extends BasePage {
    ...
    public void setPriceFilter(double lowerBoundToSet, double higherBoundToSet) {
        ...
        //wiem że tutaj mówiłeś żeby zrobić jedną metodę ale jeszcze nie wymyśliłam jak dobrze ją zrobić żeby była
        //uniwersalna
